...
class HordeSettingsScript
{
    ...
    {
        HordeLocationFuncsArray = new array<ref HordeLocationFuncs>;
        HordeCivilianList = new TStringArray;
        HordeMilitaryList = new TStringArray;
    }
    ...
    void HordeDefaultSettings()
    {
        ...
        /////////////////////////////
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(2924, 12358, "Topolniki", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(12100, 13750, "Cernaya Polana", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(9520, 8758, "Gorka", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(5950, 10300, "Grishino", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(2250, 11050, "Vavilovo", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(2750, 9950, "Lopatino", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(3786, 8923, "Vybor", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(5350, 8600, "Kabanino", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(6250, 7830, "Stary Sobor", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(7140, 7633, "Novy Sobor", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(10700, 8050, "Polana", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(10100, 5450, "Staroye", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(12050, 3550, "Kamyshovo", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(13600, 3000, "Skalisty Island", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(7550, 5100, "Moglievka", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(4500, 2450, "Balota", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(1700, 3850, "Pavlovo", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(4400, 4650, "Kozlovka", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(5850, 4750, "Nadezhdino", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(4500, 6400, "Pogorevka", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(3050, 7900, "Pustoshka", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(4950, 15050, "Stary Yar", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(6759, 14446, "Kamensk", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(13504, 14109, "Turovo", "town"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(11079, 12231, "Krasnostav", "town"));

        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(6506, 14992, "Krasnoe", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(1440, 12018, "Sinistok", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(6250, 12700, "Ratnoe", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(9500, 13750, "Svergino", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(10400, 9850, "Dubrovka", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(8400, 6650, "Guglovo", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(9650, 6550, "Shakhovka", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(12150, 7250, "Orlovets", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(12950, 8050, "Nizhnoye", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(11300, 6550, "Dolina", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(3650, 2450, "Komarovo", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(1900, 2250, "Kamenka", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(1963, 7293, "Myshkino", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(1539, 8971, "Bogatyrka", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(1159, 9956, "Zabolotye", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(3472, 14859, "Tisy", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(9372, 14508, "Nagornoe", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(13019, 15028, "Dobroe", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(14091, 14931, "Belaya Polana", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(15085, 13877, "Berezhki", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(12709, 14672, "Karmanovka", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(13404, 12900, "Olsha", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(12362, 10917, "Chelm", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(9973, 10323, "Vyshnaya Dubrovka", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(13400, 6250, "Solnechiy", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(11342, 5439, "Msta", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(12772, 4394, "Tulga", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(9101, 3961, "Pusta", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(3314, 4005, "Bor", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(3359, 4877, "Drozhino", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(437, 5218, "Zvir", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(2609, 6387, "Sosnovka", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(5009, 5638, "Pulkovo", "village"));
        HordeLocationFuncsArray.Insert(ne HordeLocationFuncs(4813, 6738, "Rogovo", "village"));
        ...
        if(players.Count() >= 60) {
           ...
           Print("[CRP HORDE] Server population above 60, performance mode activated.");
            ...
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(11852, 14477, "Central Novodmitrovsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12052, 13925, "South Novodmitrovsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(11553, 14903, "North Novodmitrovsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(10584, 14369, "West Novodmitrovsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12530, 14249, "East Novodmitrovsk", "city"));

            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7902, 12655, "Central Severograd", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7928, 12433, "South Severograd", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7927, 12906, "North Severograd", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7551, 12559, "West Severograd", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(8659, 12760, "East Severograd", "city"));

            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3450, 13050, "Central Novaya Petrovka", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3476, 13627, "North Novaya Petrovka", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3483, 12661, "South Novaya Petrovka", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3579, 13405, "East Novaya Petrovka", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3178, 12978, "West Novaya Petrovka", "city"));

            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13950, 13215, "Central Svetloyarsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13869, 13387, "North Svetloyarsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13908, 13079, "South Svetloyarsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13619, 13297, "West Svetloyarsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(14196, 13069, "East Svetloyarsk", "city"));

            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12900, 10050, "Central Lower Berezino", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12960, 10299, "North Lower Berezino", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13057, 10767, "South Lower Berezino", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12725, 10116, "West Lower Berezino", "city"));

            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12000, 9100, "South Upper Berezino", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12235, 9584, "North Upper Berezino", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(11898, 9368, "West Upper Berezino", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12207, 9297, "East Upper Berezino", "city"));

            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(10450, 2250, "Central Elektrozavodsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(10298, 2585, "North Elektrozavodsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(9750, 2096, "West Elektrozavodsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(10693, 2316, "East Elektrozavodsk", "city"));

            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6550, 2500, "Central Chernogorsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(5703, 2681, "West Chernogorsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6639, 3095, "North Chernogorsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7600, 3200, "Chyornaya Bay", "city"));

            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2656, 5260, "Central Zelenogorsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2593, 5008, "South Zelenogorsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2714, 5521, "North Zelenogorsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2326, 5246, "West Zelenogorsk", "city"));
            HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2849, 5231, "East Zelenogorsk", "city"));
        ...
        ///////////////////////////////
        // NWAF
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(4505, 10327, "Central Northwest Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(5036, 10012, "South East Northwest Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(4500, 10750, "North Northwest Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(4580, 9438, "South Northwest Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3878, 10523, "West Northwest Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3878, 10523, "North Northwest Airfield", "military"));
        // Tisy
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1650, 14200, "Central Tisy Military Base", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(631, 13697, "West Tisy Military Base", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1093, 13941, "West Tisy Military Base #2", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1808, 13687, "South Tisy Military Base", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1358, 14429, "North Tisy Military Base", "military"));
        //NEAF
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12435, 12608, "East North East Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12036, 12579, "Central North East Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(11778, 12445, "West North East Airfield", "military"));
        //Balota
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6669, 3584, "Central Balota Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6463, 3594, "West Balota Airfield", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6920, 3611, "East Balota Airfield", "military"));
        // Pavlovo Military
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2216, 3310, "South Pavlovo Military", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2119, 3546, "North Pavlovo Military", "military"));
        //Kamensk Military
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7717, 14685, "West Kamensk Military", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(8081, 14660, "East Kamensk Military", "military"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7740, 14876, "North Kamensk Military", "military"));
    ...
    static HordeSettingsScript Load()
    {
        HordeSettingsScript settings = new HordeSettingsScript();
...
static HordeBaseScript GetHordeBaseScript()
{
    if (!g_HordeBaseScript)
    {
        g_HordeBaseScript = new HordeBaseScript();
